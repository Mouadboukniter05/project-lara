...
class UserController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
	    ...
	    // $reset_demo->admin = 1 ;
	    // $reset_demo->name = 'Fatima Diraa' ;
	    // $reset_demo->email = 'diraa@test.com' ;
	    // $reset_demo->password = bcrypt('12345678') ;
	    // $reset_demo->save() ;         
    ...
    public function userCheckList($id) {
        ...
        $check_list = Check::where('user_id','=' , $id)->get();
        // return view('user.list')->with('username', $username)
        //             ->with('task_list', $task_list) ;
        return view('user.list', compact('check_list', 'username','customers') ) ;
    }
