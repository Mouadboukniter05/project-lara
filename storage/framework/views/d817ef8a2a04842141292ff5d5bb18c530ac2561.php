...
<div class="col-md-8">
    <h1><?php echo e($report_view->report_title); ?></h1>
    ...
    <div class="btn-group">
        ...
        <a href="<?php echo e(route('report.edit', ['id' => $report_view->id ])); ?>" class="btn btn-primary"> edit </a>
        <?php endif; ?>
        <a class="btn btn-default" href="<?php echo e(route('report.show')); ?>">Go Back</a>
    </div>
