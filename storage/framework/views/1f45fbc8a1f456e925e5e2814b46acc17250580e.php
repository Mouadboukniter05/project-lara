...
task_view->project->id :  <?php echo e($task_view->project->id); ?> <br>
task_view->project->project_name: <?php echo e($task_view->project->project_name); ?>  <br>
task_view->id: <?php echo e($task_view->id); ?><br>
-->


<div class="col-md-8">
    <h1><?php echo e($task_view->task_title); ?></h1>

    <div class="form-group">
        <label>Description:</label>
        <p><?php echo $task_view->task; ?></p>
    </div>
        

    <div class="btn-group">
        <a href="<?php echo e(route('task.edit', ['id' => $task_view->id ])); ?>" class="btn btn-primary"> edit </a>
        <a class="btn btn-default" href="<?php echo e(route('task.show')); ?>">Go Back</a>
    </div>
...
<div class="col-md-4">
    ...
    <div class="panel panel-jc">
        ...
        <div class="panel-body">
            <span class="label label-jc">
                <a href="<?php echo e(route('task.list', [ 'projectid' => $task_view->project->id ])); ?>"><?php echo e($task_view->project->project_name); ?></a>
            </span>
        </div>
    </div>
    ...
    <div class="panel panel-jc">
        ...
        <div class="panel-body">
            <?php if( $task_view->completed == 0 ): ?>
                <span class="label label-warning">Open</span>
                <?php if( $is_overdue ): ?>
                    <span class="label label-danger">Overdue</span>
                <?php else: ?>
                    <p><br><?php echo e($diff_in_days); ?> days left to complete this task</p>
                <?php endif; ?>                
            <?php else: ?>
