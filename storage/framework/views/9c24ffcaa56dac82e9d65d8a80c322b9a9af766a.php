...
<form id="task_form" action="<?php echo e(route('report.store')); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="col-md-8">
        <label><?php echo e(__('messages.new_Report')); ?> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span></label>

        <div class="form-group">
            <input type="text" class="form-control" placeholder="<?php echo e(__('messages.E_Report_Title')); ?>" name="raport_title">
        </div>
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            <label><?php echo e(__('messages.Select_Date')); ?> <span class="glyphicon glyphicon-calendar" aria-hidden="true"></span></label>
