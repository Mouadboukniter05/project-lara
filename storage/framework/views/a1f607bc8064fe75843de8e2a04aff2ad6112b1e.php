  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="project_form" action="<?php echo e(route('project.store')); ?>" method="POST">
...
<?php if( !$projects->isEmpty() ): ?> 
    ...
    <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
        ...
        <td>
           <a href="<?php echo e(route('task.list', [ 'projectid' => $project->id ])); ?>">List all tasks</a>
        </td>
        <td>
          <a class="btn btn-primary" href="<?php echo e(route('project.edit', [ 'id' => $project->id ])); ?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>          
          <a class="btn btn-danger" href="<?php echo e(route('project.delete', [ 'id' => $project->id ])); ?>" Onclick="return ConfirmDelete();"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>&nbsp;&nbsp;
        </td>
