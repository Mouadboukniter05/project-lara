...
<form action="<?php echo e(route('check.update', [ 'id' => $check->id ] )); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="col-md-8">
    	...
    	<div class="form-group">
    		<label>Edit Beneficiary</label>
			<input type="text" class="form-control"  name="beneficiary" value="<?php echo e($check->beneficiary); ?>">
		</div>
		<div class="form-group">
    	...
    	<div class="form-group">
    		<label>Edit coment <i class="fas fa-project-diagram    "></i></label>
			<textarea class="form-control" rows="5" id="check" name=""><?php echo e($check->coment); ?></textarea>
		</div>
		...
		<div class="form-group">
			...
			<select name="priority" class="form-control">
				<?php if( $check->priority == 0 ): ?>
			  		<option value="0" selected>Taken</option>
			  		<option value="1">Given</option>
			    <?php else: ?>
			  		<option value="0">Taken</option>
			  		<option value="1" selected>Given</option>
			  	<?php endif; ?>
			</select>
		</div>
		...
		<div class="form-group">
			...
			<select name="completed" class="form-control">
				<?php if( $check->completed == 0 ): ?>
			  		<option value="0" selected>Not Cash check</option>
			  		<option value="1">Cash check</option>
			  	<?php else: ?>
			  		<option value="0">Not Cash check</option>
			  		<option value="1" selected>Cash check</option>
			  	<?php endif; ?>
			</select>
		</div>
