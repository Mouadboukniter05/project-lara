...
<form id="check_form" action="<?php echo e(route('check.store')); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="col-md-8">
        <label><?php echo e(__('messages.Store_Check')); ?><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></label>

        <div class="form-group">
            <input type="text" class="form-control" placeholder="<?php echo e(__('messages.E_Check_Beneficiary')); ?>" name="bank">
        </div>
        <div class="form-group">
            <input type="text" class="form-control" placeholder="<?php echo e(__('messages.E_Check_Location')); ?>" name="location">
        </div>
        <div class="form-group">
            <input type="text" class="form-control" placeholder="<?php echo e(__('messages.E_Check_Amount')); ?>" name="amount">
        </div>
        <label><?php echo e(__('messages.A_Check_Files')); ?> (png,gif,jpeg,jpg,txt,pdf,doc) <span class="glyphicon glyphicon-file" aria-hidden="true"></span></label>
		<div class="form-group">
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label><?php echo e(__('messages.A_to_Customer')); ?> <span class="glyphicon glyphicon-pushpin" aria-hidden="true"></span></label>
        ...
        <div class="form-group">
            <label><?php echo e(__('messages.Select_Priority')); ?><span class="glyphicon glyphicon-warning-sign" aria-hidden="true"></span></label>
        ...
        <div class="form-group">
            <label><?php echo e(__('messages.Status')); ?><span class="glyphicon glyphicon-warning-sign" aria-hidden="true"></span></label>
        ...
        <div class="form-group">
            <label><?php echo e(__('messages.Select_Due_Date')); ?><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span></label>
