...
<form action="<?php echo e(route('projet.update', [ 'id' => $projet->id ] )); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="col-md-8">
    	...
    	<div class="form-group">
			...
			<input type="text" class="form-control"  name="projet_title" value="<?php echo e($projet->projet_title); ?>">
		</div>
    	...
    	<div class="form-group">
    		<label>Edit <i class="fas fa-project-diagram    "></i></label>
			<textarea class="form-control my-editor" rows="5" id="projet" name="projet"><?php echo e($projet->projet); ?></textarea>
		</div>

		<div class="form-group">
		<?php if( count($projetfiles) > 0  ): ?>
		<label>Files</label>
		<ul class="fileslist">
           	<?php $__currentLoopData = $projetfiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
			    <li><?php echo e($file->filename); ?> <span>&nbsp;&nbsp;</span> <a class="btn btn-danger" href="<?php echo e(route('projet.deletefile', [ 'id' => $file->id])); ?>">
              ...
              <select name="customer_id" id="customer_id" class="form-control">
                    <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($customer->id); ?>" 
                          <?php if( $projet->customer->id == $customer->id ): ?>
                                selected
                          <?php endif; ?>
        ...
        <div class="form-group">
            <label>Edit Due Date <span class="glyphicon glyphicon-calendar" aria-hidden="true"></span></label>
                ...
                <div class='input-group date' id='datetimepicker1'>
					<input type='text' class="form-control" name="duedate" value="<?php echo e($projet->duedate); ?>">
