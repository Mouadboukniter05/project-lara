...
<form id="projet_form" action="<?php echo e(route('projet.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo e(csrf_field()); ?>


    <div class="col-md-8">
        <label>Create new Customer <span class="glyphicon glyphicon-plus" aria-hidden="true"></span></label>

        <div class="form-group">
            <input type="text" class="form-control" placeholder="Enter Project Title" name="projet_title">
        </div>
        ...
        <div class="form-group">
            <textarea class="form-control my-editor" rows="10" id="projet" name="projet"></textarea>
        </div>
